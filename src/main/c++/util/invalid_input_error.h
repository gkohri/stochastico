...
#ifndef UTIL_INVALID_INPUT_ERROR_H
#define UTIL_INVALID_INPUT_ERROR_H
...
class InvalidInputError : public std::range_error {
 public:
    ...
    InvalidInputError( const char *file, const int &line, 
    ...
    virtual ~InvalidInputError() throw() {}
...
#endif   // UTIL_INVALID_INPUT_ERROR_H
