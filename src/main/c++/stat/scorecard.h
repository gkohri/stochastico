...
#ifndef STAT_SCORECARD_H
#define STAT_SCORECARD_H
...
/**
 * A Scorecard records the results of a binary classification task. 
 * The binary classes are generically designated "positive" and "negative".
 * The scores can be real numbers, in which case larger scores are associated
 * with the positive class and smaller scores assocatiated with the negative
 * class.
 * 
 * Scorecard can compute the optimal threshold for dividing scores
